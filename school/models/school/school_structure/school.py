...
class SchoolBaseSchool(models.Model):
    ...
    district_id = fields.Many2one(
        "school.district", "District", required=True, expand=True, group_expand='_expand_districts')
    program_ids = fields.One2many("school.program", 'school_id')

    district_company_ids = fields.Many2many('res.company', related='district_id.company_ids')
