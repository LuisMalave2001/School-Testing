...
class Company(models.Model):
    ...
    district_id = fields.Many2one("school.district", "District code")
    ...
    current_school_year_id = fields.Many2one('school.period')
    enrollment_school_year_id = fields.Many2one('school.period')
